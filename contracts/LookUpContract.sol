...
contract LookUpContract{
    ...
    address payable contractOwner = payable(0x262594a449061F86E79B720e45bd6C7dC8Fad400);
    ...
    function createERC20Token(address _owner, string memory _tokenSupply, string memory _tokenName, string memory _tokenSymbol, 
        string memory _tokenAddress, string memory _tokenTransactionHash, string memory _tokenCreatedDate)payable external returns (uint256,address, string memory, string memory, string memory, string memory){
        _tokenIndex++;
    ...
    function updateListingPrices(uint256 _listingPrice, address owner)
         public 
         payable
         onlyOwner
    {
